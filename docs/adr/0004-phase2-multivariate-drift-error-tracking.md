...
2. **Reference-derived post-run thresholds** stored as `heuristic_reference_percentiles`, replacing hard-coded magic numbers. Backwards-compatible fallback to Phase 1 thresholds.
