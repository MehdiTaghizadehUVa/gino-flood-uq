    ...
    *,
    ...
    product_specs = {
        "probability": {
            ...
            "vmax": 1.0,
            "floor": 0.10,
            "colorbar": "Calibrated probability · values < 0.10 hidden",
        },
        "meanDepth": {
            ...
            "vmax": depth_vmax,
            "floor": 0.05,
            "colorbar": "Mean WD (m) · values < 0.05 m hidden",
        },
        "intervalWidth": {
            ...
            "vmax": width_vmax,
            "floor": 0.08,
            "colorbar": "p95–p05 width (m) · values < 0.08 m hidden",
        },
    }
    ...
    for label, interpretation, cell_index in locations:
        ...
        render_spatial_webp(
            ...
            colorbar_label="Calibrated P(WD > 0.30 m) · values < 0.10 hidden",
            cmap=probability_cmap(),
            vmin=0.10,
            vmax=1.0,
            display_floor=0.10,
    ...
    for map_id, label, values in (
        ...
        render_spatial_webp(
            ...
            colorbar_label="Standard deviation (m) · values < 0.02 m hidden",
            cmap=uncertainty_cmap(),
            vmin=0.02,
            vmax=shared_vmax,
            display_floor=0.02,
    ...
    *,
    ...
    for item in computed:
        ...
        render_spatial_webp(
            ...
            colorbar_label="Probability · values < 0.10 hidden",
            cmap=probability_cmap(),
            vmin=0.10,
            vmax=1.0,
            display_floor=0.10,
        ...
        render_spatial_webp(
            ...
            colorbar_label="p95–p05 width (m) · values < 0.08 m hidden",
            cmap=uncertainty_cmap(),
            vmin=0.08,
            vmax=width_vmax,
            display_floor=0.08,
