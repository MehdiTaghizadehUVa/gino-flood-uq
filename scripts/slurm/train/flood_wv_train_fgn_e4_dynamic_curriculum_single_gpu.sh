...
SLURM_PARENT_JOB_ID="${SLURM_ARRAY_JOB_ID:-${SLURM_JOB_ID:-0}}"
BASE_SEED_DEFAULT=$((100000 + SLURM_PARENT_JOB_ID * 10))
...
RUN_GROUP="${RUN_GROUP_PREFIX}_${SHORT_SHA}_job${SLURM_PARENT_JOB_ID}_sbase${BASE_SEED}"
