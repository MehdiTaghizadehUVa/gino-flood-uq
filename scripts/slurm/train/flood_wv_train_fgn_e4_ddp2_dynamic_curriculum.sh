...
#SBATCH --mem=192G
#SBATCH -t 72:00:00
#SBATCH -J wv_fgn_dyn_e4
#SBATCH --array=0-3
#SBATCH -o runtime/logs/out/wv_fgn_dyn_e4-%A_%a.out
...
RUN_GROUP_PREFIX="${RUN_GROUP_PREFIX:-wdonly_fgn_ddp2_dynamic250_ar150s2e25}"
RUN_GROUP="${RUN_GROUP_PREFIX}_${SHORT_SHA}_job${SLURM_ARRAY_JOB_ID}_sbase${BASE_SEED}"
CKPT_ROOT="${CKPT_ROOT:-${PROJECT_DIR}/scripts/runtime/checkpoints_WV_depth_only_250ep_dynamic_ensemble}"
