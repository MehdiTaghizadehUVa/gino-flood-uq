...
PROJECT_DIR="${PROJECT_DIR:-/home/$USER/GINO_Model/neuraloperator_no_physics}"
EVAL_SCRIPT="${EVAL_SCRIPT:-${PROJECT_DIR}/scripts/evaluate_diffusion_forecaster_WV.py}"
EVAL_CONFIG="${EVAL_CONFIG:-${PROJECT_DIR}/config/gino_pluvial_flood_config_WV_depth_only_diffusion.yaml}"
...
CHECKPOINT_ROOT="${CHECKPOINT_ROOT:-/home/$USER/GINO_Model/neuraloperator_no_physics/scripts/checkpoints_WV_depth_only_diffusion}"
