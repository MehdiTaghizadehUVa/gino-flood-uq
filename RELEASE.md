...
- **Option 1 (recommended):** SSH key — add key to GitHub, then run `./scripts/dev/configure_github_remote_ssh.sh` and pushes work without prompts.
