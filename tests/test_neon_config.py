...
def test_default_config_matches_plan_defaults():
    ...
    assert cfg.lambda_rpf == pytest.approx(1.0e-4)
    assert cfg.lambda_smooth == pytest.approx(1.0e-3)
    assert cfg.lambda_time == pytest.approx(1.0)
    assert cfg.lambda_pos == pytest.approx(1.0e-2)
    assert cfg.lambda_mag == pytest.approx(1.0e-4)
